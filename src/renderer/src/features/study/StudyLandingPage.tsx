...
export function StudyLandingPage(): React.JSX.Element {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        <h1 className="text-lg font-semibold text-text-primary">Estudiar</h1>
        <p className="text-sm text-text-secondary">
          Elige un curso para continuar tu sesión de hoy.
        </p>
      </div>
      ...
      {courses !== null && courses.length === 0 && (
        <EmptyState
          ...
          description="Crea un curso desde tu biblioteca para empezar a estudiar."
          action={
            <Link to="/courses/new">
